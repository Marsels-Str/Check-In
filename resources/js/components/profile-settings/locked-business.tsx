        ...
        <Dialog open={true} onClose={() => {}} className="relative z-50">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <DialogPanel className="mx-auto max-w-md rounded-2xl bg-white p-6 text-center shadow-xl dark:bg-[#121212]">
                    <h2 className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-100">{t('settings.business.locked.label')}</h2>
                    <p className="mb-6 text-gray-600 dark:text-gray-400">
                        {t('settings.business.locked.text.1')}
                    </p>
                    <p className="text-sm text-gray-500 dark:text-gray-500">{t('settings.business.locked.text.2')}</p>
                    <Button
                        onClick={handleBack}
