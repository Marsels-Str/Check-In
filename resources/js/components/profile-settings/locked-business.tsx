            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <DialogPanel className="mx-auto max-w-md rounded-2xl bg-white p-6 text-center shadow-xl dark:bg-[#121212]">
                    ...
                    <p className="mb-6 text-gray-600 dark:text-gray-400">
                        You're currently working for business. You can not create you're own business until you're removed from you're current business.
                    </p>
                    <p className="text-sm text-gray-500 dark:text-gray-500">Ask you're boss to remove you, if you wish to be a business owner.</p>
                    <Button
                        onClick={handleBack}
