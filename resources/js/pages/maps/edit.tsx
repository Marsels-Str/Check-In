...
function DrawControls({ onShapeCreated, onShapeEdited }: { onShapeCreated: (data: Data) => void; onShapeEdited: (data: Data) => void }) {
    const map = useMap();
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="container px-4">
                <div className="mx-auto mt-8 w-full max-w-[600px] space-y-2 rounded-lg border p-4">
...
function InputField({ label, value, onChange, error }: { label: string; value: any; onChange: (v: string) => void; error?: string }) {
    return (
        <div>
