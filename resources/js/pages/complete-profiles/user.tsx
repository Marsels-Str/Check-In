        ...
        <>
            ...
            <div className="mx-auto w-full max-w-lg px-4 py-10">
                <div className="rounded-2xl border border-gray-200 bg-white/80 p-6 shadow-sm transition-all duration-300 dark:border-white/10 dark:bg-[#080808]/80 dark:shadow-sm">
                    <h1 className="mb-2 text-2xl font-semibold text-gray-900 dark:text-gray-100">{t('auth.complete.profile.label')}</h1>
                    <p className="mb-6 text-sm text-gray-600 dark:text-gray-400">{t('auth.complete.profile.text')}</p>
