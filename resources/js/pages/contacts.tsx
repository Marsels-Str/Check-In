...
export default function Contacts() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Contacts" />
                <h1 className="flex justify-center text-3xl font-bold leading-tight md:text-5xl">Contacts Page</h1>
                
                <div className="flex justify-center">
                    <div className="flex flex-col md:flex-row w-full max-h-[300px] gap-4 p-8">

                        <div className="flex-1 flex flex-col items-center">
                        <p className="hidden md:block text-2xl mb-2">Customer Support</p>

                        <div className='relative border border-gray-300 rounded-lg overflow-hidden h-64 w-full cursor-pointer'
                             onClick={() => setClickedFirst(prev => !prev)}>
                                
                            <svg viewBox="0 0 300 300" className={`absolute inset-0 h-full w-full transition-opacity duration-500
                                    ${clickedFirst ? "opacity-0" : "opacity-100"}`}>
                                        <g transform="translate(0,300) scale(0.100000,-0.100000)" className='fill-gray-900 dark:fill-gray-100' stroke="none">
                                            <path d="M1489 2317 c-109 -31 -220 -132 -259 -235 -91 -238 50 -486 303 -533
                                            ...
                                            <path d="M1520 2133 c-56 -50 -50 -147 11 -178 72 -38 161 -1 175 71 20 106
                                                    -106 179 -186 107z m123 -54 c17 -24 18 -30 6 -55 -19 -40 -79 -47 -103 -12
                                                    -21 30 -20 50 5 77 27 29 66 24 92 -10z"/>
                                            <path d="M1531 1918 c-19 -7 -48 -30 -65 -51 -26 -33 -31 -47 -31 -95 0 -50 2
                                            ...
                                            <path d="M380 1585 c-10 -12 -10 -18 0 -30 9 -11 34 -15 96 -15 l84 0 0 -287
                            ...
                            <div className={`absolute inset-0 flex flex-col items-center justify-center z-10 text-center transition-all duration-500 ease-in-out
                                 ${clickedFirst ? "opacity-100" : "opacity-0"}`}>
                                <p>123-456-789</p>
                        ...
                        <div className="flex-1 flex flex-col items-center">
                        <p className="hidden md:block text-2xl mb-2">Official Emails</p>

                        <div className='relative border border-gray-300 rounded-lg overflow-hidden h-64 w-full cursor-pointer'
                             onClick={() => setClickedSecond(prev => !prev)}>

                            <svg viewBox="0 0 300 300" className={`absolute inset-0 h-full w-full transition-opacity duration-500
                                ${clickedSecond ? "opacity-0" : "opacity-100"}`}>
                                    <g transform="translate(0, 250) scale(0.1, -0.1)" className='fill-gray-900 dark:fill-gray-100' stroke="none">
                                    <path d="M375 1741 c-48 -22 -79 -54 -100 -103 -13 -32 -15 -120 -15 -660 0
                                    ...
                                    <path d="M423 1676 l-28 -24 21 -29 c21 -29 81 -76 348 -273 86 -63 204 -151
                                            ...
                                            -3 1069 -7z"/>
                                    <path d="M341 1574 c-21 -26 -21 -35 -21 -578 0 -483 2 -554 16 -574 17 -24
                                            ...
                                            576 5 0 13 -6 19 -13z"/>
                                    <path d="M2565 1565 c-28 -19 -61 -43 -75 -52 -92 -64 -617 -459 -628 -472
                                            ...
                                            -259 8 -576z"/>
                                    <path d="M1177 941 c-26 -15 -67 -41 -90 -59 -23 -19 -67 -51 -97 -74 -30 -22
                            ...
                            <div className={`absolute inset-0 flex flex-col items-center justify-center z-10 text-center transition-all duration-500 ease-in-out
                                 ${clickedSecond ? "opacity-100" : "opacity-0"}`}>
                        ...
                        <div className="flex-1 flex flex-col items-center">
                        <p className="hidden md:block text-2xl mb-2">Data Protection Specialist</p>

                        <div className='relative border border-gray-300 rounded-lg overflow-hidden h-64 w-full cursor-pointer'
                             onClick={() => setClickedThird(prev => !prev)}>

                            <svg viewBox="0 0 300 300" className={`absolute inset-0 h-full w-full transition-opacity duration-500
                                ${clickedThird ? "opacity-0" : "opacity-100"}`}>
                                    <g transform="translate(0, 300) scale(0.1, -0.1)" className='fill-gray-900 dark:fill-gray-100' stroke="none">
                                        <path d="M1351 2604 c-88 -23 -171 -74 -246 -149 -114 -114 -172 -247 -180
                            ...
                            <div className={`absolute inset-0 flex flex-col items-center justify-center z-10 text-center transition-all duration-500 ease-in-out
                                 ${clickedThird ? "opacity-100" : "opacity-0"}`}>
